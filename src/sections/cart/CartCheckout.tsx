      ...
      <div className="bg-white/5 border border-white/10 rounded-[60px] p-10 shadow-2xl shadow-black/20 sticky top-32 space-y-8">
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <button
            ...
            className="group relative overflow-hidden cursor-pointer w-full bg-premium-orange text-white py-6 rounded-[24px] font-black text-lg hover:text-black transition-colors duration-500 shadow-[0_0_40px_rgba(227,6,19,0.3)] hover:shadow-[0_0_40px_rgba(255,255,255,0.2)] disabled:opacity-50 flex items-center justify-center gap-3"
          >
