...
const STEPS = [
  ...
  {
    n: '02',
    title: 'Atmosfer Yaradan',
    text: 'İnsanlar bir tədbirin tərtibatını yox, atmosferini xatırlayırlar.',
  },
  {
    n: '03',
    title: 'Şablon Yoxdur',
    text: 'Hər müştərinin ehtiyacı, hər tədbirin ritmi və hər brendin öz xarakteri var.',
  },
  {
    n: '04',
    title: 'Dərin Anlama',
    text: 'Müştərinin məqsədini, auditoriyasını və yaratmaq istədiyi hissi anlayırıq.',
  },
  {
    n: '05',
    title: 'Dinamik Fərq',
    text: 'Bəzən protokol və dəqiqlik, bəzən emosional enerji tələb olunur.',
  },
  {
    n: '06',
    title: 'Vahid Sistem',
    text: 'İlk ideyadan son saniyəyə kreativlik, texnologiya və operativ təminatı birləşdiririk.',
  },
];
        ...
        <div className="ap-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/[0.08]">
          {STEPS.map((step) => (
            ...
            >
              ...
              <h3 className="text-xl md:text-2xl font-black tracking-tight text-white leading-snug group-hover:translate-x-1 transition-transform duration-400">{step.title}</h3>
              <p className="text-[15px] text-white/50 group-hover:text-white/75 leading-[1.8] font-light transition-colors duration-400">{step.text}</p>
            </div>
          ))}
        </div>
