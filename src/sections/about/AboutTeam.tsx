...
const TEAM = [
  { name: 'Tural Rəhimov',   role: 'Təsisçi & CEO',       image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=400&auto=format&fit=crop' },
  { name: 'Leyla Əliyeva',   role: 'Tədbir Meneceri',      image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=400&auto=format&fit=crop' },
  { name: 'Rəşad Məmmədov',  role: 'Texniki Direktor',     image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?q=80&w=400&auto=format&fit=crop' },
  { name: 'Günəl Həsənova',  role: 'Satış Meneceri',       image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=400&auto=format&fit=crop' },
];
          ...
          {TEAM.map((member, i) => (
            <div key={i} className="team-card group relative overflow-hidden rounded-2xl border border-white/[0.07] hover:border-premium-orange/30 transition-all duration-500">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 translate-y-2 group-hover:translate-y-0 transition-transform duration-400">
                ...
                <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-white/45 mt-1">{member.role}</p>
              </div>
            </div>
          ))}
        </div>
