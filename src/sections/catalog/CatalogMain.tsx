    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
      <div className="flex flex-col md:flex-row justify-between items-end gap-8">
        <div className="space-y-4">
          <span className="text-premium-orange text-[10px] font-black uppercase tracking-[0.4em]">Equipment Hub</span>
          <h2 className="text-4xl md:text-6xl font-black tracking-ultra-tight uppercase">THE <span className="text-premium-orange">COLLECTION</span></h2>
        </div>
