...
export default function HomeVisionMission() {
  ...
  return (
    <>
      {/* ══ VİZYONUMUZ ══ */}
      <div ref={visionRef} className="relative bg-brand-bg flex items-center overflow-hidden min-h-[520px] md:min-h-[600px]">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-28">
          ...
          <div className="overflow-hidden mb-10">
            <h2 className="vm-v-char font-black tracking-tight leading-[0.9] uppercase text-white"
              style={{ fontSize: 'clamp(3rem, 8.5vw, 8rem)' }}>
              VİZYONUMUZ
            </h2>
          </div>

          <div className="vm-v-body max-w-lg space-y-8">
            <p className="font-inter text-white/50 text-lg md:text-xl font-light leading-[1.8]">
              Tədbir üçün bütün{' '}
      ...
      {/* ══ MİSSİYAMIZ ══ */}
      <div ref={missionRef} className="relative bg-[#060606] flex items-center overflow-hidden min-h-[560px] md:min-h-[680px]">
        ...
        <div className="vm-img-2 absolute left-0 top-0 bottom-0 w-[45%] z-0"
          ...
          <img
            ...
            referrerPolicy="no-referrer"
          />
          <div className="absolute inset-0 bg-gradient-to-l from-[#060606] via-[#060606]/55 to-transparent" />
        </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-28">
          ...
          <div className="overflow-hidden mb-10 text-right">
            <h2 className="vm-m-char font-black tracking-tight leading-[0.9] uppercase text-white"
              style={{ fontSize: 'clamp(3rem, 8.5vw, 8rem)' }}>
              MİSSİYAMIZ
            </h2>
          </div>

          <div className="vm-m-body max-w-xl ml-auto space-y-8">
            <p className="font-inter text-white/50 text-lg md:text-xl font-light leading-[1.8] text-right">
            ...
            {/* Stats row */}
            <div className="grid grid-cols-3 gap-4 md:gap-6 pt-8 border-t border-white/[0.08]">
              {[
                ...
                <div key={s.label} className="text-right space-y-2">
                  <div className="font-black tracking-tight leading-none" style={{ fontSize: 'clamp(2.5rem, 4.5vw, 4.5rem)' }}>
                    <span className="vm-stat-num text-white" data-target={s.target}>0</span>
                    <span className="text-premium-orange">{s.suffix}</span>
                  </div>
                  <div className="text-[11px] font-bold text-white/40 leading-snug tracking-wide uppercase">{s.label}</div>
                </div>
              ))}
            </div>
          </div>
