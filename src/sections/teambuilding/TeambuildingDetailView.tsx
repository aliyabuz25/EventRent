        ...
        <div className="space-y-16 py-8">
          ...
          <div className="space-y-12 pt-12 border-t border-white/5">
            ...
            <div className="space-y-8">
              <div className="flex items-center gap-4">
                <div className="w-1.5 h-10 bg-premium-orange rounded-full" />
                <h2 className="text-[10px] font-black text-white/70 uppercase tracking-[0.4em]">Tədbir Detalları</h2>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-2 sm:col-span-2">
                  <label className="text-[9px] font-black text-white/70 uppercase tracking-widest ml-4">Tarix</label>
                  <input 
                    type="date"
                    className="w-full px-8 py-5 bg-white/5 rounded-[2rem] border-2 border-transparent focus:border-premium-orange focus:bg-white/10 transition-all text-sm font-bold text-white"
            ...
            <div className="pt-12">
              ...
              <p className="text-center text-[10px] text-white/70 font-bold uppercase tracking-[0.2em] mt-8">
