  ...
  if (!pgAvail) return (
    <div>
      ...
      <div className="card border-0 shadow-sm p-5 text-center" style={{ borderRadius: 14 }}>
        ...
        <h6 className="fw-bold mb-2">PostgreSQL bağlı deyil</h6>
        <p className="text-muted mb-3" style={{ fontSize: 13 }}>Sifarişlər PostgreSQL-də saxlanılır. Serveri başladın.</p>
        <div className="p-3 rounded-3 text-start" style={{ background: '#f8f9fa', fontSize: 12, fontFamily: 'monospace' }}>
          # .env faylında PostgreSQL ayarlayın:<br/>
          PG_HOST=localhost<br/>
          PG_DATABASE=eventrent<br/>
          PG_USER=eventrent<br/>
          PG_PASSWORD=eventrent123
        </div>
      </div>
    </div>
  );
