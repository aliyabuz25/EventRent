...
const DEFAULTS: SmtpConfig = { host: '', port: 587, secure: false, user_email: '', password: '', from_name: 'Eventrent', from_email: '', notify_to: '' };
      ...
      <form onSubmit={handleSave}>
        ...
        <div className="card border-0 shadow-sm mb-3" style={{ borderRadius: 14 }}>
          <div className="card-body p-4">
            <div style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.15em', color: '#adb5bd', marginBottom: 12 }}>Tez Seçim</div>
            <div className="d-flex flex-wrap gap-2">
              {PRESETS.map(p => (
                <button
                  ...
                  className={`btn btn-sm ${form.host === p.host && p.host ? 'btn-danger' : 'btn-outline-secondary'}`}
            ...
            {form.host === 'smtp.gmail.com' && (
              <div className="mt-3 p-3 rounded-3" style={{ background: '#fff8e1', border: '1px solid #ffe082', fontSize: 12 }}>
                <strong>Gmail üçün:</strong> Google hesabında "2-addımlı doğrulama" aktiv edin, sonra "App passwords" bölməsindən 16 rəqəmli parol yaradın.
                <a href="https://myaccount.google.com/apppasswords" target="_blank" rel="noopener noreferrer" className="ms-1" style={{ color: '#e30613' }}>App Passwords →</a>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="card-body p-4">
            ...
            <div className="row g-3">
              <div className="col-md-7">
                ...
                <input className={inputCls} style={{ borderRadius: 9 }} value={form.host} onChange={e => setForm({ ...form, host: e.target.value })} placeholder="smtp.gmail.com" />
              </div>
          ...
          <div className="card-body p-4">
            ...
            <div className="row g-3">
              <div className="col-md-6">
                ...
                <input type="email" className={inputCls} style={{ borderRadius: 9 }} value={form.user_email} onChange={e => setForm({ ...form, user_email: e.target.value })} placeholder="you@gmail.com" />
              </div>
              <div className="col-md-6">
                <label className="form-label fw-semibold" style={{ fontSize: 12 }}>Parol / App Password</label>
