...
export default function EventgardenHero() {
  return (
    <section className="relative -mt-[72px] pt-32 pb-16 md:pt-40 md:pb-20 bg-gradient-to-b from-brand-bg via-brand-bg to-brand-card overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          Event <br />
          <span className="text-white/50 italic">Garden.</span>
        </motion.h1>
        ...
        >
          Bağça və açıq hava etkinlikləri üçün xüsusi konsept — çadır, dekor, işıqlandırma və səs sistemləri ilə tam həll.
        </motion.p>
      </div>
    </section>
  );
