          ...
          >
            ...
            <div className="px-8 pb-8 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
              ...
              <button
                ...
                className="group relative overflow-hidden w-full bg-white text-black py-5 rounded-[24px] font-black text-sm uppercase tracking-widest hover:text-white transition-colors duration-500 shadow-[0_0_40px_rgba(255,255,255,0.1)] hover:shadow-[0_0_40px_rgba(227,6,19,0.3)] mt-8"
              >
